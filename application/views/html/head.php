...
<script type="text/javascript" src="<?= base_url('project_files/js/app.js?time='.time()); ?>"></script>
...
<!-- App SIMA -->
<link rel="stylesheet" type="text/css" href="<?= base_url('project_files/css/basicos.css?time='.time()); ?>">       
