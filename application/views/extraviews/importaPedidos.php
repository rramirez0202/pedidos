...
<p>Pulse <a href="<?= base_url("project_files/templates/plantilla_pedido.xlsx"); ?>" target="_blanck">aquí</a> para descargar la plantilla de excel con el orden de los elementos de los pedidos a importar.</p>
<p>Pulse <a href="<?= base_url("project_files/templates/esquema_pedido.xsd"); ?>" target="_blanck">aquí</a> para descargar el archivo de definicion xml con el orden de los elementos delos pedidos a importar.</p>
<hr />